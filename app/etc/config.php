...
return [
    'modules' => [
        ...
        'LiveChat_LiveChat' => 1,
        'Magenest_Core' => 1,
        'Magenest_CouponCode' => 1,
        'Magenest_Popup' => 1,
        'Mageplaza_Core' => 1,
        'Mageplaza_Smtp' => 1,
        'Magestat_FacebookPixel' => 1,
        'Oceanpayment_Creditcard' => 1,
        'Oceanpayment_Konbini' => 1,
        'PayPal_Braintree' => 1,
        'PayPal_BraintreeGraphQl' => 1,
        'Plumrocket_Base' => 1,
        'Plumrocket_Affiliate' => 1,
        'Plumrocket_Datagenerator' => 1,
        'Prince_Productattach' => 1,
        ...
        'Zemez_AjaxCompare' => 1,
        'Zemez_AjaxSearch' => 1,
        'Zemez_AjaxWishlist' => 1,
        'Zemez_Amp' => 1,
        'Zemez_Blog' => 1,
        'Zemez_CatalogImagesGrid' => 1,
        'Zemez_CountdownTimer' => 1,
        'Zemez_FeaturedProduct' => 1,
        'Zemez_FilmSlider' => 1,
        'Zemez_GoogleMap' => 1,
        'Zemez_Megamenu' => 1,
        'Zemez_NewsletterPopup' => 1,
        'Zemez_ProductExtra' => 1,
        'Zemez_ProductLabels' => 1,
        'Zemez_ThemeOptions' => 1,
        'Zemez_ShopByBrand' => 1,
        'Zemez_SiteMaintenance' => 1,
        'Zemez_SampleDataInstaller' => 1
    ]
];
