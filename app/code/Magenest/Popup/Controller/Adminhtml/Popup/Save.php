...
class Save extends \Magenest\Popup\Controller\Adminhtml\Popup\Popup
{
    ...
    public function execute()
    {
        ...
        try {
            ...
            $customer_group_ids = isset($params['customer_group_ids']) ? $params['customer_group_ids'] : '';
            ...
            $floating_button_text_hover_color = isset($params['floating_button_text_hover_color']) ? $params['floating_button_text_hover_color'] : '';
            $floating_button_background_color = isset($params['floating_button_background_color']) ? $params['floating_button_background_color'] : '';
            $floating_button_hover_color = isset($params['floating_button_hover_color']) ? $params['floating_button_hover_color'] : '';
            ...
            $popupTemplate = $this->_popupTemplateFactory->create()->load($popup_template_id);
            if (!$html_content) {
                $html_content = $popupTemplate->getHtmlContent();
            }

            $background_image = isset($params['background_image']) ? $this->json->serialize($params['background_image']) : '';
            ...
            if (!$css_style) {
                $css_style = $popupTemplate->getCssStyle();
            }
            ...
            $popupModel->setFloatingButtonTextHoverColor($floating_button_text_hover_color);
            $popupModel->setFloatingButtonBackgroundColor($floating_button_background_color);
            $popupModel->setFloatingButtonHoverColor($floating_button_hover_color);
    ...
    /**
     * @param $popup_type
     * @return \Magenest\Popup\Model\Template|\Magento\Framework\DataObject
     */
