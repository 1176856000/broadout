...
/**
 * Class Layout
 * @package Magenest\Popup\Block\Adminhtml\Popup\Instance\Edit\Tab\Main
 */
class Layout extends \Magento\Widget\Block\Adminhtml\Widget\Instance\Edit\Tab\Main\Layout
{
    ...
    public function _getDisplayOnSelectHtml()
    {
        $selectBlock = $this->getLayout()->createBlock(
            ...
            "onchange=\"WidgetInstance.displayPageGroup(this.value+\'_<%- data.id %>\')\" data-form-part=\"magenest_popup_edit\""
        )->setOptions(
