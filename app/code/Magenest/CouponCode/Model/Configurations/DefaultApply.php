...
class DefaultApply extends AbstractFields
{
    ...
    const SALESRULE_CUSTOMER_GROUP_TABLE = 'salesrule_customer_group';
    const SALESRULE_COUPON_USAGE_TABLE = 'salesrule_coupon_usage';
    const SALESRULE_COUPON_TABLE = 'salesrule_coupon';
    const SALESRULE_WEBSITE_TABLE = 'salesrule_website';
    ...
    public function apply($rules)
    {
        ...
        $select->join(
            ...
            ['customer_group_id' => new \Zend_Db_Expr('group_concat(DISTINCT `customer_group`.customer_group_id SEPARATOR ",")')]
