...
class ConfigProvider extends ConfigProviderAbstract
{
    ...
    const CONFIG_PATH_GENERAL_SITE_KEY_V3 = 'general/captchaKeyV3';
    const CONFIG_PATH_GENERAL_SECRET_KEY_V3 = 'general/captchaSecretV3';
    ...
    {
        $configPath = self::CONFIG_PATH_GENERAL_SITE_KEY;
        if ($this->getCaptchaVersion() == CaptchaVersion::VERSION_3) {
            $configPath = self::CONFIG_PATH_GENERAL_SITE_KEY_V3;
        }
    ...
    {
        $configPath = self::CONFIG_PATH_GENERAL_SECRET_KEY;
        if ($this->getCaptchaVersion() == CaptchaVersion::VERSION_3) {
            $configPath = self::CONFIG_PATH_GENERAL_SECRET_KEY_V3;
        }
